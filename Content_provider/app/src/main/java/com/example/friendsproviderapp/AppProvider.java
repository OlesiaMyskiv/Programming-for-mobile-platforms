...
public class AppProvider extends ContentProvider {
    ...
    // Числові коди для розмежування операцій
    public static final int FRIENDS = 100;
    public static final int FRIENDS_ID = 101;

    // Об'єкт для розпізнавання URI
    private static final UriMatcher sUriMatcher = buildUriMatcher();

    // Метод для побудови UriMatcher
    ...
    // Ініціалізація бази даних при створенні провайдера
    @Override
    ...
    // Метод getType() - Повернення типу вмісту
    @Nullable
    @Override
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        if (match == FRIENDS) {
            ...
            long recordId = db.insert(FriendsContract.TABLE_NAME, null, values);
